...
?>
                ...
                for (let i = 0 ; i < usage_time_array.length ; i++) {
                    ...
                    if (split_id[3] == "sum") {
                        ...
                        /** 如要修改id為usagetime-XXX-XXX-sum的hidden input的name值請在這邊修改
                            ...
                            第二個鍵值代表是哪一組，這邊training_strategy代表目標調控組；
        ...
        <div class="d-grid pt-5 pb-3 px-2 text-center">
            <h2>請依照您使用「健康上網表單」的情況回答下列問題，幫助我們暸解您上週的情形，同時也請您回顧和思考。（手機使用時間請參照iPhone的「螢幕使用時間」功能，電腦使用時間請自行評估）</h2>
        </div>
            ...
            <?php echo '<form id="form" action="self_evaluate_ios_submit.php?u_id=' . $user['id'] . '" method="POST">' ?>
                ...
                <div class="border-secondary border-opacity-50 border-bottom w-95 mx-3 py-3">
                    ...
                    <div id="question-1_3" class="container clearfix">
                        <h4>3. 在網頁上為自己設定使用時間減量目標，第幾天?&nbsp;&nbsp;星期：</h4>
                        <div class="float-start">
                    ...
                    <div id="question-1_4" class="container clearfix">
                        <h4>4. 每天達成目標後，網頁有給予我獎勵點數，第幾天?&nbsp;&nbsp;星期：</h4>
                        <div class="float-start">
                    ...
                    <div class="container clearfix">
                        ...
                        <div class="float-start">
                            <select id="q1_6-0-0" class="form-select py-3 mx-3" name="answer_sheet[self_evaluate][training_strategy][question][q1_6]" required>
                                <option value="">請選擇</option>
                                <option value="0">零次</option>
