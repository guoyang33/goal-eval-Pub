...
<main>
<h1 class="visually-hidden">管理員系統</h1>

<div class="container px-4 py-5" id="featured-1">

<h2 class="pb-2 border-bottom">參與者管理</h2>
...
<div class="feature col">
        ...
        <h2>參與者列表</h2>
        <p>顯示參與者狀態</p>
        <a href="/admin/user_list.php" class="icon-link">
            顯示
    ...
    <div class="feature col">
        ...
        <h2>新增參與者</h2>
        <p>建立學號與研究編號的對應資料</p>
        <a href="/admin/user_add.php" class="icon-link">
            新增
            <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
        </a>
    </div>
    ...
    <h2>表單填寫狀態</h2>
    <p>查看參與者的表單填寫狀態</p>
    <a href="/admin/progress_overview" class="icon-link" target="_blank">
    檢視
    <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
    </a>
    </div>
