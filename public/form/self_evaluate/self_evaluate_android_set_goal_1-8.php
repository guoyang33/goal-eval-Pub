            ...
            <?php echo '<form id="form" action="self_evaluate_android_submit.php?u_id=' . $user['id'] . '" method="POST">' ?>
                ...
                <div class="border-secondary border-opacity-50 border-bottom w-95 mx-3 py-3">
                    ...
                    <div class="container clearfix">
                        ...
                        <div class="float-start">
                            <input id="q1_5-1-1" class="form-check-input p-3 mx-3" type="radio" name="answer_sheet[self_evaluate][set_goal][question][q1_5]" value="1" required>
                            <label for="q1_5-1-1" class="mt-2 pe-5"><h3>是</h3></label>
                        </div>
                        <div class="float-start">
                            <input id="q1_5-0-0" class="form-check-input p-3 mx-3" type="radio" name="answer_sheet[self_evaluate][set_goal][question][q1_5]" value="0">
